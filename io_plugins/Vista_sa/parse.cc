// Generated by Bisonc++ V5.02.00 on Wed, 09 Nov 2016 21:25:43 +0100
...
void VistaParserBase::setDebug(bool mode)
{
    d_actionCases__ = false;
    d_debug__ = mode;
}

void VistaParserBase::setDebug(DebugMode__ mode)
{
...
// $insert executeactioncases
    ...
    switch (production)
    {
        ...
        case 5:
        {
         std::cout << "Magic " << d_vsp__[0].get<Tag__::STRING>() << std::endl;
         }
        break;

        case 6:
        {
         std::cout << "Entry " << d_vsp__[-2].get<Tag__::STRING>() << "=" << d_vsp__[0].get<Tag__::STRING>() << std::endl;
         d_val__ = std::make_pair(d_vsp__[-2].get<Tag__::STRING>(),d_vsp__[0].get<Tag__::STRING>());
         }
        break;
