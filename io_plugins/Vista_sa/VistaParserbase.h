...
inline VistaParserBase::DebugMode__ operator|(VistaParserBase::DebugMode__ lhs, 
                                     VistaParserBase::DebugMode__ rhs)
{
    return static_cast<VistaParserBase::DebugMode__>(static_cast<int>(lhs) | rhs);
};
...
inline bool VistaParserBase::actionCases() const
{
...
inline VistaParserBase::DebugMode__ operator&(VistaParserBase::DebugMode__ lhs,
                                     VistaParserBase::DebugMode__ rhs)
{
    return static_cast<VistaParserBase::DebugMode__>(
