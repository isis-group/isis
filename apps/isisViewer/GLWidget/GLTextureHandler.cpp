...
std::map<ImageHolder, GLuint> GLTextureHandler::copyAllImagesToTextures( const DataContainer &data )
{
...
GLuint GLTextureHandler::copyImageToTexture( const DataContainer &data, const ImageHolder &image, size_t timestep )
{
	...
	return internCopyImageToTexture<TYPE>( data, GL_UNSIGNED_BYTE, image, timestep );
