...
BOOST_PYTHON_MODULE ( _data )
{
	...
	//  IOFactory
	//#######################################################################################
	bool ( *_writeImage1 ) ( const isis::data::Image &, const std::string &, const std::string &, const isis::util::istring & ) = isis::python::data::_IOFactory::_write;
	...
	bool ( *_writeImages1 ) ( std::list<isis::data::Image> &, const std::string &, const std::string &, const isis::util::istring & ) = isis::python::data::_IOFactory::_write;
	...
	std::list<isis::data::Image> ( *_loadImages1 ) ( const std::string &, const std::string &, const isis::util::istring & ) = isis::python::data::_IOFactory::_load;
