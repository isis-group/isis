...
namespace _internal
{
enum types { BOOL, INT8_T, UINT8_T, INT16_T, UINT16_T, INT32_T, UINT32_T, INT64_T, UINT64_T, FLOAT, DOUBLE,
FVECTOR4, DVECTOR4, IVECTOR4, ILIST, DLIST, SLIST, STDSTRING, SELECTION, COMPLEX_FLOAT,
