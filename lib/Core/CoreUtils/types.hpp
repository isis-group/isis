...
std::map<unsigned short, std::string> getTypeMap( bool witValues = true, bool withValuePtrs = true );

std::map< std::string, unsigned short> getTransposedTypeMap( bool witValues = true, bool withValuePtrs = true );
}
}
