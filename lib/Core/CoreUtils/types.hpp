...
std::map<unsigned short, std::string> getTypeMap( bool withTypes = true, bool withValuePtrs = true );

std::map< std::string, unsigned short> getTransposedTypeMap( bool withTypes = true, bool withValuePtrs = true );
}
}
