...
public:
	...
	virtual std::pair<util::TypeReference,util::TypeReference> getScale(const util::_internal::TypeBase &min, const util::_internal::TypeBase &max, autoscaleOption scaleopt = autoscale)const=0;
