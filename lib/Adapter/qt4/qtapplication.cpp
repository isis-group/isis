...
std::shared_ptr< isis::util::MessageHandlerBase > isis::qt4::IOQtApplication::getLogHandler( std::string /*module*/, isis::LogLevel level )const
{
	return std::shared_ptr< isis::util::MessageHandlerBase >( level ? new isis::qt4::QDefaultMessagePrint( level ) : 0 );
}
