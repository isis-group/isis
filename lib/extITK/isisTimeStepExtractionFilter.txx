...
template<class TInputImage, class TOutputImage>
void TimeStepExtractionFilter<TInputImage, TOutputImage>::GenerateOutputInformation() {
...
template<class TInputImage, class TOutputImage>
void TimeStepExtractionFilter<TInputImage, TOutputImage>::GenerateData() {
	...
	if (!m_RequestedTimeRangeBegin and !m_RequestedTimeRangeEnd) {
		...
		if (m_RequestedTimeRangeEnd - m_RequestedTimeRangeBegin > 1) {
			...
			m_InputSize[OutputImageDimension - 1] = m_RequestedTimeRangeEnd
					- m_RequestedTimeRangeBegin;
